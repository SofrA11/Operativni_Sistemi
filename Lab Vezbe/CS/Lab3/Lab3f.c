/*Korišćenjem programskog jezika C napisati Linux progam koji se deli u dva
procesa. Jedan proces čita liniju po liniju datoteku prva.txt, a drugi datoteku
druga.txt. Ova dva procesa upisuju naizmenično pročitane linije u tekstualnu
datoteku zbir.txt tako da su sve neparne linije iz datoteke prva.txt, a parne iz
datoteke druga.txt.*/

/*Korišćenjem programskog jezika C napisati Linux program koji simulira
komunikaciju između niti korišćenjem celobrojnih bafera. Nit N0 generiše
celobrojne podatke i upisuje ih u bafere B1, B2 i B3. Prilikom upisivanja
podataka, nit N0, najpre proverava da li u baferu B3 ima slobodnih pozicija i u
tom slučaju novi podatak upisuje u bafer B3. Ako je bafer B3 pun, proverava da
li postoje slobodne pozicije u baferu B1. Ako postoje, proizvođač N0 generisani
podataka upisuje u bafer B1. Ukoliko je i bafer B1 pun novi podatak se upisuje u
bafer B2 ukoliko on poseduje slobodne pozicije. Ukoliko ni u jednom baferu nema
slobodnih pozicija, nit N0 čeka, dok se u nekom od bafera ne oslobodi pozicija
za upis novog elementa. Niti N1, N2, N3 čitaju podatke iz bafera B1, B2, B3 i
prikazje ih na standardnom izlazu. Za sinhronizaciju između niti iskoristiti
POSIX semafore.*/
#include <pthread.h>
#include <semaphore.h>
#include <stdio.h>
...
main() {
    ...
    /*semafor mutex_empty pamti ukupan broj slobodnih pozicija u sva tri
     * bafera*/

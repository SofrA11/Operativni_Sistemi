/*Korišćenjem programskog jezika C kreirati višenitni Linux proces. U okviru
procesa se izvršavaju tri niti (N1, N2 i N3) koje pristupaju deljivom resursu.
Deljivi rersurs je predstavljen celobrojnim nizom od 20 elemenata. Niti
pristupaju deljivom resursu na sledeći način: • Nit N1, na svake 2 sekunde,
upisuje slučajnu vrednost na slučajnu poziciju u prvoj polovini niza (pozicije 0
do 9). • Nit N2, na svake 4 sekunde, upisuje slučajnu vrednost na slučajnu
poziciju u drugoj polovini niza (pozicije 10 do 19). • Nit N3, na svakih 8
sekundi, upisuje slučajnu vrednost na slučajnu poziciju u nizu (pozicije 0 do
19).
Korišćenjem nekog od poznatih mehanizama za sinhronizaciju i međusobno
isključenje niti, obezbediti da nit N3 može da pristupi deljivom resursu samo
ako u datom trenutku deljivom resursu ne pristupa ni nit N1 ni nit N2.
*/
#include <pthread.h>
#include <stdio.h>
#include <stdlib.h>

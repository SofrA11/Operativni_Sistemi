/*Korišćenjem programskog jezika C napisati Linux progam koji sadrži bafer u
koji se mogu smestiti dva integer broja. Zasebna nit periodično generiše dva
broja (u opsegu od 1 do 10) i upisuje ih u ovaj bafer. Kada se u baferu nađe
novi par brojeva glavna nit (main funkcija) treba da odredi zbir ta dva broja i
odštampa ga na standardnom izlazu. Vremenski razmak između dva uzastopna upisa u
bafer je slučajna vrednost između 0 i 5 sekundi.*/

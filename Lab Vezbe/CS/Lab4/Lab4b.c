/*Modofikovati rešenje iz prethodnog zadatka takod a su tri procesa datavodima
povezani u krug. Drugi proces dete ne štampa rečenicu već je datavodom šalje
procesu roditelju koji je onda štampa na standardni izlaz bez ikakve
modifikacije.*/

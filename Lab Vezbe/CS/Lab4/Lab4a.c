/*Korišćenjem programskog jezika C napisati Linux program koji kreira dva
dodatna procesa. Proces roditelj i ova dva novokreirana procesa deteta su
povezana datavodima u red. Proces roditelj prihvata rečenicu po rečenicu koje
korisnik unosi sa tastature. Korišćenjem datavoda proces roditelj unetu rečenicu
prosleđuje prvom procesu detetu. Ovaj proces proverava da li je prvi karakter u
rečenici veliko slovo i ukoliko nije konvertuje ga u odgovarajuće veliko slovo.
Rečenicu zatim, koristeći datavod, šalje drugom procesu detetu. Naredni proces
proverava da li je poslednji karakter u rečenici tačka (.). Ukoliko nije dodaje
tačku i rečenicu štampa na standardnom izlazu.*/
